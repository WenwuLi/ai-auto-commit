/**
 * 默认系统提示词（与插件内置 .cursorrules 模板一致）
 */
export const DEFAULT_COMMIT_RULES = `# Git 提交信息规则
...
### 示例 3：重构
\`\`\`
refactor(首页主题管理): 优化主题配置管理

将主题配置的 useState 迁移到 useReducer，
提升主题配置管理的可维护性
\`\`\`

### 示例 4：文档更新
\`\`\`
docs(首页主题管理): 更新主题配置说明
